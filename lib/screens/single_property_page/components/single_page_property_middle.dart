...
class _SinglePagePropertyMiddleDesktopState
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                AutoSizeText("Allie Grater",
                                  style: GoogleFonts.montserrat(
                                      fontSize: 18,
                                      fontWeight: FontWeight.w400,
                                      color: Color.fromRGBO(28, 45, 58, 1)),
                                ),
                                AutoSizeText("Sep 25, 2022",
                                  style: GoogleFonts.montserrat(
                                      fontSize: 15,
                                      //fontWeight: FontWeight.w600,
                                      color: Color.fromRGBO(28, 45, 58, 1)),
                                ),
                                AutoSizeText("We were there for 3 nights and \n hotel was too good. Greenery \n was flaunting everywhere. \n There were games kept for our \n entertainment.",
                                  style: GoogleFonts.montserrat(
                                      fontSize: 15,
                                      //fontWeight: FontWeight.w600,
                                      color: Color.fromRGBO(28, 45, 58, 1)),
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                AutoSizeText("Walter Melon",
                                  style: GoogleFonts.montserrat(
                                      fontSize: 18,
                                      fontWeight: FontWeight.w400,
                                      color: Color.fromRGBO(28, 45, 58, 1)),
                                ),
                                AutoSizeText("Oct 20, 2022",
                                  style: GoogleFonts.montserrat(
                                      fontSize: 15,
                                      //fontWeight: FontWeight.w600,
                                      color: Color.fromRGBO(28, 45, 58, 1)),
                                ),
                                AutoSizeText("There are small activities that you \n can indulge with your family. Very \n  cool landscaping has been done \n Around the hotel. The location, view \n from the rooms are just awesome.",
                                  style: GoogleFonts.montserrat(
                                      fontSize: 15,
                                      //fontWeight: FontWeight.w600,
                                      color: Color.fromRGBO(28, 45, 58, 1)),
  ...
  SizedBox getMiddleWidget(String menuValue, double width){
    if(menuValue == "LOCATION"){
      return SizedBox(height: width/2, width: width,child: SinglePagePropertyMiddleLocationContainer(location: widget.propertyDetails["location"],));
    }
    else if(menuValue == "ABOUT") {
      return SizedBox(height: width/2, width: width,child: SinglePagePropertyMiddleAboutContainer(propertyDetails: widget.propertyDetails["property_about"],));
    }
    else if(menuValue == "FEATURE") {
      return SizedBox(height: width/2, width: width,child: SinglePagePropertyMiddleFeaturesContainer());
    }
    else if(menuValue == "GALLERY") {
      return SizedBox(height: width/2, width: width,child: SinglePagePropertyMiddleGalleryContainer());
    }
    else if(menuValue == "VIDEO") {
      return SizedBox(height: width/2, width: width,child: SinglePagePropertyMiddleVideoContainer());
    }
    else if(menuValue == "FLOOR PLAN") {
      return SizedBox(height: width/2, width: width,child: SinglePagePropertyMiddleFloorPlanContainer());
    }
    else{
