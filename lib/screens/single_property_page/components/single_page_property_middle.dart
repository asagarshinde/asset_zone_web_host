...
class _SinglePagePropertyMiddleDesktopState
  ...
  SizedBox getMiddleWidget(String menuValue, double width){
    if(menuValue == "LOCATION"){
      ...
      return SizedBox( width: width,child: SinglePagePropertyMiddleAboutContainer(propertyDetails: widget.propertyDetails["property_about"],));
    }
    else if(menuValue == "FEATURE") {
      return SizedBox( width: width,child: SinglePagePropertyMiddleFeaturesContainer());
    }
    else if(menuValue == "GALLERY") {
      return SizedBox(width: width,child: SinglePagePropertyMiddleGalleryContainer());
    }
    else if(menuValue == "VIDEO") {
      return SizedBox( width: width,child: SinglePagePropertyMiddleVideoContainer());
    }
    else if(menuValue == "FLOOR PLAN") {
      return SizedBox(width: width,child: SinglePagePropertyMiddleFloorPlanContainer());
    }
    else{
